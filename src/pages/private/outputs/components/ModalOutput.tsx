...
import { OutputMaterials, OutputProducts } from ".";
...
export const ModalOutput = ({ updateOutputs, open, handlerOpen }: ModalOutputProps) => {
        ...
        >
            ...
            >
                <Box alignItems='center' display='flex' marginBottom={2} justifyContent='space-between'>
                    <Typography variant="h4" color='primary'>Nuevo egreso</Typography>
                ...
                {selectedButton === 'materiales' && <OutputMaterials updateOutputs={updateOutputs} resetSelectedOption={resetSelectedButton} handleAlert={handleAlert}/>}
                {selectedButton === 'productos' && <OutputProducts />}
